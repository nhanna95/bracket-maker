...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        for i in range(30):
            ...
            layout.addWidget(
                b, button_placements[i][0], button_placements[i][1])
...
# Nixon, Yakub, Arnav, Juwon, Mason, Subbu
    ...
    def advance_player(self, index):
        ...
        win_placements = [12, 12, 13, 13, 14, 14, 15, 15, 17, 17, 19, 19, 20,
                          20, 21, 21, 22, 22, 23, 23, 26, 26, 25, 25, 27, 27, -1, 29, -1, -1]
        lose_placements = [8, 8, 9, 9, 10, 10, 11, 11, -1, -1, -1, -1, 18,
                           18, 16, 16, -1, -1, -1, -1, 24, 24, -1, -1, -1, -1, 28, -1, -1, -1]
        opponent_placements = [1, 0, 3, 2, 5, 4, 7, 6, 9, 8, 11, 10, 13, 12,
                               15, 14, 17, 16, 19, 18, 21, 20, 23, 22, 25, 24, 27, 26, 29, 28]
